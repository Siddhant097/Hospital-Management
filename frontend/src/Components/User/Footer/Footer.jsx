...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="#" target="_blank" rel="noreferrer noopener">Siddhant Mukund</a> </strong>{'Copyright ©'}
                    ...
                    <Grid container
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.linkedin.com/in/siddhant-mukund-292a85258/" target="_blank" rel="noopener noreferrer" >
                                    LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/Siddhant097" target="_blank" rel="noopener noreferrer" >
                                    GitHub
                                </a>
                            </Stack >
